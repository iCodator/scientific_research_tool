...
# VERSION: v1.2.1 (Fixed: Regex syntax error in is_field_term)
...
# v1.2.1 - Fixed: Regex syntax error in is_field_term pattern (Dec 18, 2025)
#
# KEY FEATURES:
...
def is_field_term(token: str) -> bool:
    ...
    # Pattern explanation:
    # ^                    = start of string
    # ([\"'])              = capture group 1: either " or ' (note: escaped quotes)
